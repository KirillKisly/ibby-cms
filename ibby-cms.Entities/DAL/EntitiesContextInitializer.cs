    ...
    public class EntitiesContextInitializer : DropCreateDatabaseIfModelChanges<EntitiesContext> {
        protected override void Seed(EntitiesContext context) {
            ...
            var menu = new List<Menu> {
                new Menu {Code="Header_menu1", Title="Title_menu1"},
                new Menu {Code="Header_menu2", Title="Title_menu2"},
                new Menu {Code="Header_menu3", Title="Title_menu3"},
                new Menu {Code="Header_menu4", Title="Title_menu4"},
                new Menu {Code="Header_menu5", Title="Title_menu5"},
                new Menu {Code="Header_menu6", Title="Title_menu6"},
                new Menu {Code="Header_menu7", Title="Title_menu7"},
                new Menu {Code="Header_menu8", Title="Title_menu8"}
            };

            menu.ForEach(c => context.Menus.Add(c));
            context.SaveChanges();

            var menuItem = new List<MenuItem> {
                new MenuItem{MenuID =1, PageID = 1, Title="Title_menuItem1", Url="Url_menuItem1"},
                new MenuItem{MenuID =2, PageID = 2, Title="Title_menuItem2", Url="Url_menuItem2"},
                new MenuItem{MenuID =3, PageID = 3, Title="Title_menuItem3", Url="Url_menuItem3"},
                new MenuItem{MenuID =4, PageID = 4, Title="Title_menuItem4", Url="Url_menuItem4"},
                new MenuItem{MenuID =5, PageID = 5, Title="Title_menuItem5", Url="Url_menuItem5"},
                new MenuItem{MenuID =6, PageID = 6, Title="Title_menuItem6", Url="Url_menuItem6"},
                new MenuItem{MenuID =7, PageID = 7, Title="Title_menuItem7", Url="Url_menuItem7"},
                new MenuItem{MenuID =8, PageID = 8, Title="Title_menuItem8", Url="Url_menuItem8"}
            };

            menuItem.ForEach(c => context.MenuItems.Add(c));
            context.SaveChanges();
        }
    }
}